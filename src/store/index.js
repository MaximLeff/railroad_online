...
const store = createStore({
    state () {
        return {
            ...
            cars_mini: carsMini,
            cargos: cargos,
            cars_cargos_calculation: carsMini
        }
    },
    getters:{
        getCurrentCar(state){
        ...
        getСalcCarsCargos(state) {
            return state.cars_cargos_calculation
        }
    },
    mutations: {
        ...
        calcCarsCargos(state, {quantity, car_name, getters}) {
            let car_arr = []
    ...
    actions: {
        ...
        calcCarsCargos(context, {quantity, car_name}) {
            this.commit('calcCarsCargos',{quantity, car_name});
        }
    }
})
